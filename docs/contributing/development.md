...
本页面向准备修改 AgentDock 源码、文档或第一方 Skill 的贡献者。普通安装请从 [安装 AgentDock](../getting-started/install.md) 进入。
...
普通用户如何使用 Skill，见 [使用 Skill](../concepts/skills.md)。
...
- 文档改动上线后实际访问页面。
- Release、签名、生产部署和维护者机器操作应遵循源码仓库当前维护规范，不复制到普通用户页面。
